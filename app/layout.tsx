...
export const metadata: Metadata = {
  title: "Volodymyr Babiichuk | Code_PRO: Frontend, Mobile, React, Next.js, Java Script, Type Script, Flutter, Dart, Tailwind CSS, and Flutter Developer Portfolio and Services",
