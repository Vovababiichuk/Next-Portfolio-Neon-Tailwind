...
const SkillsSection = () => {
  return (
    <section id="skills" className='mt-[-60px] max-sm:mt-[-220px]'>
      <MainTitle title="My Skills" subTitleType="skills" />

      <div
        className="m-auto flex flex-col items-center justify-center gap-3 h-full relative overflow-hidden mt-[-140px] max-sm:mt-[-290px] z-[140] py-6"
        ...
        <div className="w-full h-full absolute">
          <div className="w-full h-full z-[-10] opacity-30 absolute flex items-center justify-center bg-cover max-sm:hidden">
            <video
